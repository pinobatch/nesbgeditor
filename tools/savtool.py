...
This program translates NES color numbers (00 to 3F) to sRGB colors
using a palette generated by a web app created by Joel Yliluoma.
https://bisqwit.iki.fi/utils/nespalette.php
The --write-swatches option writes out this file
